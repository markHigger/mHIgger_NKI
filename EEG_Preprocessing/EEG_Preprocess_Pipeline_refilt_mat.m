function success = EEG_Preprocess_Pipeline_refilt_mat(filepath_input, varargin)
...
if (removePA)
    ...
    %set highpass filter to remove HF noise introduced by PA removal
    F_low = 0.1;
    F_high = 70;
    EEG_PA = EEG_Bandpass_Matlab(EEG_PA, F_low, F_high);
