EEG_Preproce_test_2_8 MATLAB Python Package
...
2. Installing the EEG_Preproce_test_2_8 Package

A. Change to the directory that contains the file setup.py and the subdirectory 
EEG_Preproce_test_2_8. If you do not have write permissions, copy all its contents to a 
...
3. Using the EEG_Preproce_test_2_8 Package
...
The EEG_Preproce_test_2_8 package is on your Python path. To import it into a Python 
script or session, execute:

    import EEG_Preproce_test_2_8
