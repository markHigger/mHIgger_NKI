...
#include <stdio.h>
#define EXPORTING_EEG_Preproc_test_v2_6 1
#include "EEG_Preproc_test_v2_6.h"
...
LIB_EEG_Preproc_test_v2_6_C_API 
        ...
        return false;
    {
        mclCtfStream ctfStream = 
            mclGetEmbeddedCtfStream((void 
                                                     *)(EEG_Preproc_test_v2_6InitializeWithHandlers));
        if (ctfStream) {
...
{
    return EEG_Preproc_test_v2_6InitializeWithHandlers(mclDefaultErrorHandler, 
