...
#include <stdio.h>
#define EXPORTING_EEG_Preproc_v2_3 1
#include "EEG_Preproc_v2_3.h"
    ...
    mclOutputHandlerFcn print_handler)
{
        ...
        return false;
    {
        mclCtfStream ctfStream = 
            mclGetEmbeddedCtfStream((void *)(EEG_Preproc_v2_3InitializeWithHandlers));
        if (ctfStream) {
...
{
    return EEG_Preproc_v2_3InitializeWithHandlers(mclDefaultErrorHandler, 
