EEG_Preproc_4_4 MATLAB Python Package
...
2. Installing the EEG_Preproc_4_4 Package

A. Change to the directory that contains the file setup.py and the subdirectory 
EEG_Preproc_4_4. If you do not have write permissions, copy all its contents to a 
...
3. Using the EEG_Preproc_4_4 Package
...
The EEG_Preproc_4_4 package is on your Python path. To import it into a Python script or 
session, execute:

    import EEG_Preproc_4_4
