ParResPkg MATLAB Python Package
...
2. Installing the ParResPkg Package

A. Change to the directory that contains the file setup.py and the subdirectory 
ParResPkg. If you do not have write permissions, copy all its contents to a temporary 
...
The ParResPkg package is on your Python path. To import it into a Python script or 
session, execute:
